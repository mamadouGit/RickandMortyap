...
- Using [tailwind](https://tailwindcss.com/) and [daisyUI](https://daisyui.com/) as a CSS framework
- Using [http-server](https://www.npmjs.com/package/http-server) to serve the content
- Using [JavaScript modules](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules) to organise our code

### What we should have learned

- How to use a CSS framework rather than writing our own CSS
- How to serve assets using a lightweight server for development
- How to use JavaScript modules (in the browser) to keep complexity abstracted
- How to use callbacks to pass information between functions and modules
...
- Learn about [JavaScript modules](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules)
- Finish adding the rest of the logic in the project, make more API calls and render the content related to characters and locations (see below)
